...
There are six comparators and no more. Which ones apply depends on the Question's kind:
...
for a person goes to Slack; otherwise an urgent message and any complaint or question become a
