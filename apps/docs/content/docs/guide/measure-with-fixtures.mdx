...
description: Label a handful of real Records, then let siftline test grade the Recipe.
---
...
That report is real: the docs run this command against recorded model answers every time the
site is built.
...
Next: [run the Recipe on real Records](/docs/guide/label-records).
